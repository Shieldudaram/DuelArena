...
public final class ArenaDropItemDropEventSystem extends EntityEventSystem<EntityStore, DropItemEvent.Drop> {

    private final ArenaService arenaService;
    private final DuelService duelService;

    public ArenaDropItemDropEventSystem(ArenaService arenaService, DuelService duelService) {
