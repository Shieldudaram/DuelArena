...
public final class ArenaBreakBlockEventSystem extends EntityEventSystem<EntityStore, BreakBlockEvent> {

    private final ArenaService arenaService;

    public ArenaBreakBlockEventSystem(ArenaService arenaService) {
