...
public final class ArenaUseBlockEventSystem extends EntityEventSystem<EntityStore, UseBlockEvent.Pre> {

    private final ArenaService arenaService;

    public ArenaUseBlockEventSystem(ArenaService arenaService) {
