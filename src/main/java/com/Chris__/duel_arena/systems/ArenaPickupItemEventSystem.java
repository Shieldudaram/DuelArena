...
public final class ArenaPickupItemEventSystem extends EntityEventSystem<EntityStore, InteractivelyPickupItemEvent> {

    private final ArenaService arenaService;
    private final DuelService duelService;

    public ArenaPickupItemEventSystem(ArenaService arenaService, DuelService duelService) {
    ...
    public void handle(int index,
        ...
        if (s != null && s.isActiveCombat()) {
            event.setCancelled(true); // NOTE: may be ignored by the engine (best-effort)
            return;
        }
