...
public final class ArenaDamageBlockEventSystem extends EntityEventSystem<EntityStore, DamageBlockEvent> {

    private final ArenaService arenaService;

    public ArenaDamageBlockEventSystem(ArenaService arenaService) {
